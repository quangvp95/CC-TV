...
class CoccocMainFragment : BrowseSupportFragment() {
...
//                val intent = Intent(context!!, CoccocDetailsActivity::class.java)
//                intent.putExtra(CoccocDetailsActivity.MOVIE, item)
//
//                val bundle = ActivityOptionsCompat.makeSceneTransitionAnimation(
//                    activity!!,
//                    (itemViewHolder.view as ImageCardView).mainImageView,
//                    CoccocDetailsActivity.SHARED_ELEMENT_NAME
//                )
//                    .toBundle()
...
//                    startActivity(intent)
    ...
    companion object {
        private val TAG = "CoccocMainFragment"

        private val BACKGROUND_UPDATE_DELAY = 300
        private val GRID_ITEM_WIDTH = 200
        private val GRID_ITEM_HEIGHT = 200
        private val NUM_ROWS = 6
        private val NUM_COLS = 0
    }
}